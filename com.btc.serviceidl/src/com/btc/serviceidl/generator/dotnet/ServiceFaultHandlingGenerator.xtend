...
class ServiceFaultHandlingGenerator extends GeneratorBase
{
   def String generate(String className, EObject owner)
   {
      ...
      val raisedExceptions = com.btc.serviceidl.util.Util.getRaisedExceptions(owner)
      ...
      public static class «className»
      {
         ...
         static «className»()
         {
            ...
            «FOR e : raisedExceptions.sortBy[name] SEPARATOR System.lineSeparator»
               errorMap["«com.btc.serviceidl.util.Util.getCommonExceptionName(e, qualified_name_provider)»"] = typeof(«resolve(e)»);
            «ENDFOR»
         }
