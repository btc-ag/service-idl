...
class LibResolver
{
   ...
   private static val cab_additional_dependencies = #{
      ...
      ,"ServiceComm/API/include/IClientEndpoint.h"                               -> #["BTC.CAB.ServiceComm.ProtobufUtil.lib", "BTC.CAB.ServiceComm.Commons.lib", "BTC.CAB.ServiceComm.CommonsUtil.lib", "BTC.CAB.Commons.FutureUtil.lib"]
      ,"ServiceComm/Default/include/BaseMessageTypes.h"                          -> #["BTC.CAB.ServiceComm.API.lib", "BTC.CAB.ServiceComm.Protobuf.Common.lib"]
      ,"ServiceComm/PerformanceBase/include/ServerBase.h"                        -> #["BTC.CAB.IoC.Container.lib", "BTC.CAB.Logging.Default.lib", "BTC.CAB.ServiceComm.TestBase.lib", "BTC.CAB.Performance.CommonsUtil.lib", "BTC.CAB.Performance.Framework.lib", "BTC.CAB.Performance.Base.lib"]
      ,"ServiceComm/ProtobufBase/include/AProtobufServiceDispatcherBase.h"       -> #["BTC.CAB.ServiceComm.Base.lib", "BTC.CAB.Commons.CoreOS.lib"]
      ,"ServiceComm/ProtobufBase/include/AProtobufServiceProxyBase.h"            -> #["BTC.CAB.ServiceComm.Base.lib", "BTC.CAB.Commons.CoreOS.lib", "BTC.CAB.ServiceComm.Commons.lib"]
      ,"ServiceComm/ProtobufUtil/include/ProtobufMessageDecoder.h"               -> #["BTC.CAB.ServiceComm.Commons.lib", "BTC.CAB.ServiceComm.Util.lib"]
      ,"ServiceComm/Util/include/DispatcherAutoRegistration.h"                   -> #["BTC.CAB.Commons.CoreExtras.lib", "BTC.CAB.Commons.FutureUtil.lib", "BTC.CAB.ServiceComm.API.lib", "BTC.CAB.ServiceComm.Commons.lib", "BTC.CAB.Commons.CoreOS.lib"]
      ,"ServiceComm.SQ/ZeroMQTestSupport/include/CZeroMQTestConnection.h"        -> #["BTC.CAB.ServiceComm.SQ.API.lib", "BTC.CAB.ServiceComm.SQ.ZeroMQ.lib", "BTC.CAB.ServiceComm.SQ.Default.lib", "BTC.CAB.ServiceComm.SQ.ImportAPI.lib"]
   }
