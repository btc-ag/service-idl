...
public class CMakeProjectSetFactory implements IProjectSetFactory {
    ...
    @Override
    public void generateProjectFiles(IFileSystemAccess fileSystemAccess, ITargetVersionProvider targetVersionProvider,
        ...
        new CMakeProjectFileGenerator(fileSystemAccess, targetVersionProvider, externalDependencies, projectReferences,
