...
package com.btc.cab.servicecomm.prodigd.validation

import java.util.regex.Pattern

class KeywordValidator
{
   def static boolean isKeyword(String word, int pattern)
   {
      return word.isCppKeyword(pattern)
      || word.isCSharpKeyword(pattern)
      || word.isJavaKeyword(pattern)
    ...
    */
   def static private boolean isCppKeyword(String word, int pattern)
   {
      val keywords =
      #[
         "alignas",
    ...
    */
   def static private boolean isJavaKeyword(String word, int pattern)
   {
      val keywords =
      #[
         "abstract",
    ...
    */
   def static private boolean isCSharpKeyword(String word, int pattern)
   {
      val keywords =
      #[
         "abstract",
    ...
    */
   def static private boolean isProtobufKeyword(String word, int pattern)
   {
      val keywords =
      #[
         "descriptor"
