...
class DotNetGeneratorTest extends AbstractGeneratorTest
{
    ...
    def void testBasicServiceApi()
    {
        ...
        val baseDirectory = IFileSystemAccess::DEFAULT_OUTPUT +
            "dotnet/Infrastructure/ServiceHost/Demo/API/ServiceAPI/"
    ...
    {
        checkGenerators(input, new HashSet<ArtifactNature>(Arrays.asList(ArtifactNature.DOTNET)), projectTypes, fileCount,
            contents)
    }
}
