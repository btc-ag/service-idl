...
class JavaGeneratorTest extends AbstractGeneratorTest
{
    ...
    {
        val fileCount = 5 // TODO this includes the KeyValueStoreServiceFaultHandlerFactory, which should be generated to a different project, and not with these settings
