    ...
    def void testWithValidInputInProcess()
    {
        ...
        assertExpectedFiles(
            #["cpp/modules/BTC/Commons/Core/Common/BTC.Commons.Core.Common.vcxproj",
                ...
                "dotnet/BTC/Commons/Core.NET/Protobuf/paket.references", "dotnet/base.sln", "dotnet/paket.dependencies",
                "dotnet/paket.template", "java/pom.xml", "java/com.btc.commons.core.common/pom.xml",
    ...
    def void testWithValidInputWithWarningsInProcess()
    {
        ...
        assertExpectedFiles(
            #["cpp/modules/BTC/Commons/Core/Dispatcher/BTC.Commons.Core.Dispatcher.vcxproj",
                ...
                "dotnet/failable.sln", "dotnet/paket.dependencies", "dotnet/paket.template", "java/pom.xml",
    ...
    def void testWithImport()
    {
        ...
        assertExpectedFiles(
            #["cpp/modules/Derived/Common/BTC.PRINS.Derived.Common.vcxproj",
                ...
                "dotnet/Imported.NET/Protobuf/paket.references", "dotnet/import-derived.sln", "dotnet/import-imported.sln",
